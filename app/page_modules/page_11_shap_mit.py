...
def render():
    ...
    **Goal: Identification of important ECG signal parts for decision making of the model**
    ...
    with st.expander("ECG Signal with SHAP Values Overlay", expanded=False):
        ...
        # Class 0
        with tab0:
            example_num = st.selectbox("Select example:", [1, 2, 3], key="class0_example")
            image_path = os.path.join(
                os.path.dirname(__file__),
                "..",
                "images",
        ...
        # Class 1
        with tab1:
            example_num = st.selectbox("Select example:", [1, 2, 3], key="class1_example")
            image_path = os.path.join(
                os.path.dirname(__file__),
                "..",
                "images",
        ...
        # Class 2
        with tab2:
            example_num = st.selectbox("Select example:", [1, 2, 3], key="class2_example")
            image_path = os.path.join(
                os.path.dirname(__file__),
                "..",
                "images",
        ...
        # Class 3
        with tab3:
            example_num = st.selectbox("Select example:", [1, 2, 3], key="class3_example")
            image_path = os.path.join(
                os.path.dirname(__file__),
                "..",
                "images",
        ...
        # Class 4
        with tab4:
            example_num = st.selectbox("Select example:", [1, 2, 3], key="class4_example")
            image_path = os.path.join(
                os.path.dirname(__file__),
                "..",
                "images",
