...
def render():
    ...
    **Relevance:**   
    ...
    - **Class 0 (Normal):**  
        ...
        """)
    st.image("app/images/page_3/mit_c0_low-extreme.png", caption="MIT example plots of Class 0 heartbeats with extremely short RR-distances")
    st.image("app/images/page_3/mit_c0_up-extreme.png", caption="MIT example plots of Class 0 heartbeats with extremely long RR-distances")
    ...
    st.image("app/images/page_3/MIT_r.png", caption=" MIT RR-distances distribution per class with extreme values highlighted")
    ...
    """)
    st.image("app/images/page_3/ptb_c0_low-extreme.png", caption="PTB example plots of Class 0 heartbeats with extremely short RR-distances")
    ...
    st.image("app/images/page_3/PTB_r.png", caption="PTB RR-distances distribution per class with extreme values highlighted")
