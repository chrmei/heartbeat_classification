...
class ModelSaver:
    ...
    def model_exists(self, classifier_name: str, experiment_name: str = "default") -> bool:
        """
    ...
    def get_model_info(self, classifier_name: str, experiment_name: str = "default") -> Dict:
        """
...
def create_model_saver(base_dir: str = "models/exploration_phase") -> ModelSaver:
    """
